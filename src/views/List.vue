...
<!--&lt;!&ndash; v-permission ="['admin']"   </nav>&ndash;&gt;-->

<!--    <main>-->
<!--      &lt;!&ndash;        //当el-table元素中注入data对象数组后，在el-table-column中用prop属性来对应对象中的键名即可填入数据，用label属性来定义表格的列名。&ndash;&gt;-->
<!--      &lt;!&ndash;        //stripe带斑马纹，border竖直方向的边框的&ndash;&gt;-->
<!--      <el-table-->
<!--        :data="tableData"-->
...
<!--          &lt;!&ndash;    v-model	绑定值，auto-complete原生属性，自动补全&ndash;&gt;-->
<!--        </el-form-item>-->
...
<!--          <el-input v-model="addForm.explain" auto-complete="off" type="textarea" :rows="6" resize="none"-->
<!--                    placeholder="请输入英雄背景"></el-input>-->
<!--        </el-form-item>-->
<!--        &lt;!&ndash;rows输入框行数，只对 type="textarea" 有效&ndash;&gt;-->
...
<!--        <el-form-item label="背景:" :label-width="formLabelWidth" prop="explain">-->
<!--          <el-input v-model="modifyForm.explain" auto-complete="off" type="textarea" :rows="6" resize="none"-->
<!--                    placeholder="请输入英雄背景"></el-input>-->
<!--        </el-form-item>-->
...
<!--          ],-->
<!--          heroPosition: [-->
<!--            {required: true, message: "至少选择一个英雄位置", trigger: "change"},-->
...
<!--        var createParmas = {-->
<!--          heroName: this.addForm.heroName,-->
<!--          heroPosition: this.addForm.heroPosition,-->
<!--          heroSex: this.addForm.heroSex,-->
<!--          address: this.addForm.address,-->
<!--          age: this.addForm.age,-->
<!--          explain: this.addForm.explain,-->
<!--          favourite: this.addForm.favourite-->
<!--        };-->
...
<!--&lt;!&ndash;input：&ndash;&gt;-->
<!--&lt;!&ndash;resize	控制是否能被用户缩放&ndash;&gt;-->
<!--&lt;!&ndash;autocomplete	原生属性，自动补全&ndash;&gt;-->
<!--&lt;!&ndash;rows	输入框行数，只对 type="textarea" 有效&ndash;&gt;-->
<!--&lt;!&ndash;placeholder	输入框占位文本&ndash;&gt;-->
<!--&lt;!&ndash;clearable	是否可清空&ndash;&gt;-->
<!--&lt;!&ndash;disabled	禁用&ndash;&gt;-->
<!--&lt;!&ndash;value / v-model	绑定值&ndash;&gt;-->
<!--&lt;!&ndash;show-password	是否显示切换密码图标&ndash;&gt;-->
<!--&lt;!&ndash;prefix-icon	输入框头部图标&ndash;&gt;-->
<!--&lt;!&ndash;suffix-icon	输入框尾部图标&ndash;&gt;-->
<!--&lt;!&ndash;event：&ndash;&gt;-->
<!--&lt;!&ndash;blur	在 Input 失去焦点时触发	(event: Event)&ndash;&gt;-->
<!--&lt;!&ndash;focus	在 Input 获得焦点时触发	(event: Event)&ndash;&gt;-->
<!--&lt;!&ndash;change	在 Input 值改变时触发	(value: string | number)&ndash;&gt;-->
<!--&lt;!&ndash;clear	在点击由 clearable 属性生成的清空按钮时触发&ndash;&gt;-->

<!--&lt;!&ndash;v-bind v-model&ndash;&gt;-->
<!--&lt;!&ndash;加冒号的，说明后面的是一个变量或者表达式；没加冒号的后面就是对应的字符串字面量！省v-bind&ndash;&gt;-->
<!--&lt;!&ndash;<p v-bind:class="someclass"></p>&ndash;&gt;-->
<!--&lt;!&ndash;1&ndash;&gt;-->
<!--&lt;!&ndash;如果不加 v-bind 那么 someclass 就是个常量，没有任何动态数据参与。当加上 v-bind 之后，它的值 someclass 不是字符串，而是vue实例对应的 data.someclass 这个变量&ndash;&gt;-->
<!--&lt;!&ndash;@：省v-on：监听事件&ndash;&gt;-->
